...
var texture = new THREE.TextureLoader().load('/src/images/kitodanfrontend_middle.png');
var texture2 = new THREE.TextureLoader().load('src/images/kitodanfrontend_out.png');
